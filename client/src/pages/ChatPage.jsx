			...
			<div className='flex-grow flex flex-col p-4 md:p-6 lg:p-8 overflow-hidden max-w-4xl mx-auto w-full'>
				<div className='flex items-center mb-4 bg-white rounded-lg shadow p-3'>
					<img
						...
						className='w-12 h-12 object-cover rounded-full mr-3 border-2 border-primary'
					/>
...
const MatchNotFound = () => (
	<div className='h-screen flex flex-col items-center justify-center bg-[#f5f7ff]'>
		<div className='bg-white p-8 rounded-lg shadow-md text-center'>
			<UserX size={64} className='mx-auto text-primary mb-4' />
			...
			<Link
				...
				focus:outline-none focus:ring-2 focus:ring-primary inline-block'
			>
				Go Back To Home
			</Link>
		</div>
