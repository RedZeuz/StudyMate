...
const HomePage = () => {
	...
	return (
		<div className='flex flex-col lg:flex-row min-h-screen bg-gradient-to-br from-[#e8ecff] to-[#f5f7ff] overflow-hidden'>
			<Sidebar />
...
const NoMoreProfiles = () => (
	<div className='flex flex-col items-center justify-center h-full text-center p-8'>
		<Frown className='text-primary mb-6' size={80} />
		<h2 className='text-3xl font-bold text-gray-800 mb-4'>No More Study Partners!</h2>
		<p className='text-xl text-gray-600 mb-6'>Take a break and come back later for more matches.</p>
	</div>
);
	...
	return (
		<div className='relative w-full max-w-sm h-[28rem]'>
			<div className='card bg-white w-96 h-[28rem] rounded-lg overflow-hidden border border-gray-200 shadow-sm'>
				...
				<div className='card-body bg-gradient-to-b from-white to-[#e8ecff] p-4'>
